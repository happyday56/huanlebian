...
import com.lgh.huanlebian.jdbc.SimpleConnectionProvider;
...
public class JdbcServiceImpl implements JdbcService {
    ...
    @Override
    public void runJdbcWork(JdbcService.ConnectionConsumer connectionConsumer) throws SQLException, UnsupportedEncodingException {
    ...
    @Override
    public void runStandaloneJdbcWork(ConnectionConsumer connectionConsumer) throws SQLException, UnsupportedEncodingException {
        log.debug("Prepare to run jdbc");
        Connection connection = entityManager.unwrap(Connection.class);
        if (connection==null){
