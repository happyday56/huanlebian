...
//            initCategoryKind();
    ...
    private void initCategory() {
        ...
        description = "欢乐变亲子网以备孕男女、孕产妇为主要服务对象，提供备孕、孕早中晚期等各个特定时间段的专业知识，内容涵盖孕前准备、孕妇的饮食、保健、疾病等方面。致力于用鲜活实用的知识，打造受众人群每日必读的孕育宝典。";
        ...
        description = "欢乐变亲子网产后频道以产后妈妈为主要服务对象，致力于为产后妈妈提供全方位的产后恢复、身心保健知识。频道下设女性健康、产后减肥、产后美容等多个栏目，帮助妈妈平稳健康的度过产后恢复期，塑造美丽健康新形象。";
        ...
        description = "欢乐变亲子网育儿频道致力于服务新手父母，并按宝贝的成长提供分阶段的婴幼儿养育知识。频道划分为新生儿、0-1岁、1-3岁、3-6岁四个栏目，涵盖婴幼儿喂养、护理、健康等各方面相关的育儿资讯，让您的育儿生活更加丰富。";
        parentCategory = new Category(0L, null, "育儿", CatetoryConstant.yuer, "儿童营养与健康,小儿喂养,小儿护理,小儿疾病,儿童营养食谱,幼儿健康,幼儿健康教育", description, 3);
        parentCategory = categoryRepository.save(parentCategory);
        list.add(new Category(0L, parentCategory, "新生儿", CatetoryConstant.xinshenger, "新生儿,新生儿黄疸,新生儿睡眠,新生儿护理,新生儿喂养,新生儿起名,新生儿抚触,母乳喂养", "欢乐变亲子网新生儿频道，提供全面的新生儿护理和新生儿喂养资讯。介绍内容包括新生儿护理、新生儿发育、新生儿喂养、新生儿疾病、早产儿、母婴交流等栏目。太平洋亲子网，让新手爸爸妈妈学会育儿！", 1));
        list.add(new Category(0L, parentCategory, "0-1岁", CatetoryConstant.yinger, "婴儿,婴儿腹泻,婴儿护理,婴儿湿疹,婴儿睡眠,婴儿辅食,母乳喂养,婴儿早期教育", "欢乐变亲子网婴儿频道，提供最新最全的婴儿护理、喂养常识，内容包括婴儿发育、婴儿营养、婴儿护理、婴儿疾病、婴儿教育等栏目。太平洋亲子网，让爸爸妈妈成为育儿高手！", 2));
        list.add(new Category(0L, parentCategory, "1-3岁", CatetoryConstant.youer, "幼儿,幼儿食谱,幼儿教育,幼儿保健,幼儿行为习惯,幼儿心理健康,入托", "欢乐变亲子网幼儿频道是太平洋亲子网的一个主要频道。它提供全方位的幼儿护理常识和幼儿教育知识和技巧。内容包括幼儿饮食、幼儿护理、幼儿发育、幼儿心理、幼儿疾病和幼儿教育等栏目。让爸爸妈妈成为育儿专家！", 3));
        list.add(new Category(0L, parentCategory, "3-6岁", CatetoryConstant.xuelingqian, "学龄前,学龄前儿童护理,儿童饮食,小儿常见病,儿童心理,儿童行为习惯,幼儿园,幼小衔接,学龄前教育", "欢乐变亲子网学龄前频道，全方位介绍了学龄前儿童护理、儿童饮食、小儿常见病、儿童心理、幼儿园、学龄前教育等知识和育儿技巧。让爸爸妈妈成为育儿专家！", 4));
        categoryRepository.save(list);
